...
from main.conversValues import *
...
class Convers(Frame):
    def __init__(self, parent, db):
        ...
        v.barValue.trace('w', v.size_check)
        self.entry_bar = Entry(self.mainPart, justify=RIGHT,
                               font=('Comic Sans', 15), width=8,
                               textvariable=v.barValue)
        ...
        v.lengthValue.trace('w', v.size_check)
        self.entry_length = Entry(self.mainPart, justify=RIGHT,
                                  font=('Comic Sans', 15), width=8,
                                  textvariable=v.lengthValue)
        ...
        v.weigthValue.trace('w', v.size_check)
        self.entry_weigth = Entry(self.mainPart, justify=RIGHT,
                                  font=('Comic Sans', 15), width=8,
                                  textvariable=v.weigthValue)
        ...
        v.volumeValue.trace('w', v.size_check)
        self.entry_volume = Entry(self.mainPart, justify=RIGHT,
                                  font=('Comic Sans', 15), width=8,
                                  textvariable=v.volumeValue)
        ...
        v.areaValue.trace('w', v.size_check)
        self.entry_area = Entry(self.mainPart, justify=RIGHT,
                                font=('Comic Sans', 15), width=8,
                                textvariable=v.areaValue)
        ...
        v.speedValue.trace('w', v.size_check)
        self.entry_speed = Entry(self.mainPart, justify=RIGHT,
                                 font=('Comic Sans', 15), width=8,
                                 textvariable=v.speedValue)
        ...
        v.tempValue.trace('w', v.size_check)
        self.entry_temp = Entry(self.mainPart, justify=RIGHT,
                                font=('Comic Sans', 15), width=8,
                                textvariable=v.tempValue)
        ...
        v.energyValue.trace('w', v.size_check)
        self.entry_energy = Entry(self.mainPart, justify=RIGHT,
                                  font=('Comic Sans', 15), width=8,
                                  textvariable=v.energyValue)
    ...
    # Выполнение перевода величин температуры
